...
async fn handle_list_bookings<T>(
...
where
    T: super::operations::BookingsApi,
{
    api.list_bookings(ctx).await
}
pub fn bookings_router<T>(api: std::sync::Arc<T>) -> orator_axum::axum::Router
where
    T: super::operations::BookingsApi,
    T::Error: orator_axum::axum::response::IntoResponse,
    T::RequestContext:
        orator_axum::axum::extract::FromRequestParts<std::sync::Arc<T>> + Send + 'static,
{
    orator_axum::axum::Router::new()
        .route(
            "/bookings",
            orator_axum::axum::routing::get(handle_list_bookings::<T>),
        )
        .with_state(api)
}
...
async fn handle_list_courts<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
) -> Result<super::operations::ListCourtsResponse, T::Error>
where
    T: super::operations::CourtsApi,
{
...
async fn handle_upload_court_photo<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
...
pub fn courts_router<T>(api: std::sync::Arc<T>) -> orator_axum::axum::Router
where
    T: super::operations::CourtsApi,
    T::Error: orator_axum::axum::response::IntoResponse,
    T::RequestContext:
        orator_axum::axum::extract::FromRequestParts<std::sync::Arc<T>> + Send + 'static,
{
    orator_axum::axum::Router::new()
        .route(
            "/courts",
            orator_axum::axum::routing::get(handle_list_courts::<T>),
        )
        .route(
            "/courts/{court_id}/photo",
            orator_axum::axum::routing::put(handle_upload_court_photo::<T>),
        )
        .with_state(api)
}
...
async fn handle_health_check<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
) -> Result<super::operations::HealthCheckResponse, T::Error>
where
    T: super::operations::HealthApi,
{
    api.health_check(ctx).await
}
pub fn health_router<T>(api: std::sync::Arc<T>) -> orator_axum::axum::Router
where
    T: super::operations::HealthApi,
    T::Error: orator_axum::axum::response::IntoResponse,
    T::RequestContext:
        orator_axum::axum::extract::FromRequestParts<std::sync::Arc<T>> + Send + 'static,
{
    orator_axum::axum::Router::new()
        .route(
            "/health",
            orator_axum::axum::routing::get(handle_health_check::<T>),
        )
        .with_state(api)
}
...
async fn handle_list_members<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
...
async fn handle_create_member<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
...
async fn handle_update_member<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
    orator_axum::axum::extract::Path(member_id): orator_axum::axum::extract::Path<
        orator_axum::uuid::Uuid,
...
async fn handle_delete_member<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
    orator_axum::axum::extract::Path(member_id): orator_axum::axum::extract::Path<
        orator_axum::uuid::Uuid,
...
async fn handle_get_member_photo<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
    orator_axum::axum::extract::Path(member_id): orator_axum::axum::extract::Path<
        orator_axum::uuid::Uuid,
...
async fn handle_upload_member_photo<T>(
    orator_axum::axum::extract::State(api): orator_axum::axum::extract::State<std::sync::Arc<T>>,
    ctx: T::RequestContext,
    orator_axum::axum::extract::Path(member_id): orator_axum::axum::extract::Path<
        orator_axum::uuid::Uuid,
...
pub fn members_router<T>(api: std::sync::Arc<T>) -> orator_axum::axum::Router
where
    T: super::operations::MembersApi,
    T::Error: orator_axum::axum::response::IntoResponse,
    T::RequestContext:
        orator_axum::axum::extract::FromRequestParts<std::sync::Arc<T>> + Send + 'static,
{
    orator_axum::axum::Router::new()
        .route(
            "/members",
            orator_axum::axum::routing::get(handle_list_members::<T>)
                .post(handle_create_member::<T>),
        )
        .route(
            "/members/{member_id}",
            orator_axum::axum::routing::get(handle_get_member::<T>)
                .patch(handle_update_member::<T>)
                .delete(handle_delete_member::<T>),
        )
        .route(
            "/members/{member_id}/photo",
            orator_axum::axum::routing::get(handle_get_member_photo::<T>)
                .put(handle_upload_member_photo::<T>),
        )
        .with_state(api)
}
pub struct Missing;
