...
#[test]
fn form_urlencoded_axum_handlers() {
    let code = generate_axum_from_yaml(
...
#[test]
fn mixed_content_types_axum_handlers() {
    let code = generate_axum_from_yaml(
            ...
            application/json:
              schema:
                ...
                items:
                  type: string
        "204":
          description: No content but a header
          headers:
            X-Trace-Id:
              required: true
              schema:
